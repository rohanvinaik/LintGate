...
Proactive professional cognition stack for LLM coding agents. Fires on every Write, Edit, and Bash via PostToolUse hooks. 81 MCP tools for on-demand analysis.
...
- **AGENTS.md** — tool reference + self-integration for all agents (81 tools by cognitive mode)
