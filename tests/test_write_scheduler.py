...
class TestImmediateTriggers:
    ...
    def test_immediate_ignores_cooldown(self):
        ...
        assert should_write(ws, current_generation=2, trigger="mode_transition", now=100.1) is True
...
class TestCadencedTriggers:
    ...
    def test_tool_call_not_dirty_skips(self):
        ...
        assert should_write(ws, current_generation=2, trigger="tool_call", now=1000.0) is False
    ...
    def test_tool_call_dirty_under_cooldown_skips(self):
        ...
        # Only 5s elapsed
        assert should_write(ws, current_generation=2, trigger="tool_call", now=105.0) is False
    ...
    def test_tool_call_dirty_past_cooldown_interval_met(self):
        ...
        assert should_write(ws, current_generation=2, trigger="tool_call", now=135.0) is True
    ...
    def test_tool_call_dirty_past_cooldown_interval_not_met(self):
        ...
        assert should_write(ws, current_generation=2, trigger="tool_call", now=135.0) is False
    ...
    def test_lint_complete_dirty_past_cooldown(self):
        ...
        assert should_write(ws, current_generation=2, trigger="lint_complete", now=135.0) is True
    ...
    def test_lint_complete_not_dirty_skips(self):
        ...
        assert should_write(ws, current_generation=2, trigger="lint_complete", now=200.0) is False
    ...
    def test_timer_dirty_past_cooldown(self):
        ...
        assert should_write(ws, current_generation=2, trigger="timer", now=135.0) is True
    ...
    def test_max_interval_forces_write(self):
        ...
        assert should_write(ws, current_generation=2, trigger="tool_call", now=400.0) is True
    ...
    def test_max_interval_not_reached(self):
        ...
        assert should_write(ws, current_generation=2, trigger="tool_call", now=300.0) is False
...
class TestSkipConditions:
    def test_same_generation_always_skips(self):
        ...
        assert should_write(ws, current_generation=5, trigger="mode_transition") is False
...
class TestStateMutations:
    def test_record_write(self):
        ws = WriteScheduler(dirty=True, tool_calls_since_write=15, writes_this_session=2)
