...
def test_version_checker_passes_project_root(tmp_path):
    ...
    with mock.patch("lintgate.linters.version_checker.collect_required_version_specs") as mock_collect, \
         mock.patch("lintgate.linters.version_checker.inspect_tool_versions") as mock_inspect:

        mock_collect.return_value = {"ruff": {"specifiers": [">=0.4"], "sources": ["pyproject.toml"]}}
