...
- _behavior_soft_action: premature_action, tool_repetition, consecutive_failures
- _behavior_soft_verification: serial_discovery, verification_debt, integration_verification_debt
- _behavior_soft_workflow: stale_model, mass_delegation, redundant_planning
...
from ._behavior_soft_action import (
...
from ._behavior_soft_verification import (
    INTEGRATION_PATHS,
...
from ._behavior_soft_workflow import (
