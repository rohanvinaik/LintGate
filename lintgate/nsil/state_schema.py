...
class CompactSerializer(Protocol):
    def serialize_compact(
        self, format: Literal["structured_text", "json_flat", "kv_pairs"], budget: int
    ) -> str: ...

    @classmethod
    def from_compact(cls, data: str, format: Literal["json_flat", "kv_pairs"]) -> Any: ...
...
class InferenceStateSnapshot:
    ...
    def serialize_compact(
        self,
        format: Literal["structured_text", "json_flat", "kv_pairs"] = "structured_text",
    ...
    def _serialize_to_format(
        self, data: dict[str, Any], format: Literal["structured_text", "json_flat", "kv_pairs"]
    ) -> str:
    ...
    @classmethod
    def from_compact(
        cls, data: str, format: Literal["json_flat", "kv_pairs"]
