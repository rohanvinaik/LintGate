...
def _compile_dangerous_command_constraint(constraint: str) -> dict[str, str]:
...
def _compile_verification_constraint(constraint: str) -> dict[str, str]:
...
def _compile_path_scope_constraint(constraint: str) -> dict[str, str]:
