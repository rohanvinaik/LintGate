"""Compass helpers — shared compute for mcp_tools/compass_tools.py and scripts/compass_manage.py.

All pure compute (no CLI, no subprocess concerns). Moved here from
mcp_tools/compass_tools.py so both the MCP thin wrapper and the standalone
script can import the same functions, and tests can import from either
location via re-export.
"""
