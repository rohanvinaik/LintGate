    ...
    try:
        ...
        if tool_name in ("Agent", "EnterPlanMode", "Task"):
            try:
                ...
                from lintgate.hooks.habit import record_behavior_event
...
def _finalize_report(
    ...
    from lintgate.hooks.arbitration import arbitrate_output
...
from .posttooluse_controlplane import (  # noqa: F401, E402
    _check_prescriptive_specs,
    _collect_cycle_interventions,
    _collect_delivery_items,
