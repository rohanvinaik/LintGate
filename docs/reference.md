...
| `platonic_project`        | Golden-path entrypoint: choose the first deterministic high-value target |
| `platonic_converge`       | Iterative spec convergence loop: profile, generate, validate to target |
