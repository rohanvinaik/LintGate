...
106 MCP tools. 18 linters. 6 parallel analysis channels. No LLM inference in the supervision path — symbolic checks on a CPU, at the speed your agent writes code.
...
*106 MCP tools, configuration reference, and setup details: [docs/reference.md](docs/reference.md)*
